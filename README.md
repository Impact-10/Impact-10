...
<!-- ====== INSANE ANIMATED HERO SECTION (UPGRADED) ====== -->
<div align="center" style="margin-top:38px; margin-bottom:0;">
  <!-- Animated glass panel with multi-layered effects -->
  <div style="
    width:99vw; max-width: 1720px;
    border-radius: 38px;
    margin: 0 auto 0 auto;
    padding: 64px 0 54px 0;
    background: linear-gradient(120deg, #0f3460 60%, #00eaff33 100%), radial-gradient(ellipse 88% 160% at 50% -20%, #00eaff60 20%, #23293b 90%);
    box-shadow: 0 0 80px 12px #00eaff88, 0 0 240px 38px #00e5e544, 0 0 0 12px #0f346044;
    position: relative;
    overflow:hidden;
    border: 2.5px solid #00eaff33;
    ">
    <h1 style="
      font-family: 'JetBrains Mono', 'Fira Code', 'Fira Mono', 'Consolas', monospace;
      font-size: 4.6em;
      text-align: center;
      font-weight: 900;
      text-shadow: 
        ...
        0 2px 0 #111, 
        0 0 1px #fff;
      background: repeating-linear-gradient(90deg,#00eaff 0%,#00e676 40%,#b388ff 70%, #00eaff 100%);
      background-size: 300% 300%;
      -webkit-background-clip: text;
      -webkit-text-fill-color: transparent;
      animation: crazyHeaderBG 4.6s linear infinite, crazyHeaderFlicker 1.6s infinite alternate;
      letter-spacing: 8px;
      filter: drop-shadow(0 0 18px #00eaff88);
      margin: 0;
      user-select: none;
      position: relative;
      z-index: 2;
      ...
      <span style="position:relative;">
        <span style="animation:glitch1 1.6s infinite alternate;">GANESH A</span>
      </span>
    </h1>
    <div style="
      font-size:2em;
      color:#fff;
      font-weight:900;
      text-shadow: 0 0 28px #00eaff, 0 0 16px #00eaff, 0 0 52px #00eaffbb, 0 2px 40px #00eaff;
      letter-spacing:3.5px;
      margin-top:18px;
      margin-bottom:10px;
      background: linear-gradient(90deg,#00eaff, #00e676, #b388ff, #00eaff);
      background-size: 180% 180%;
      -webkit-background-clip: text;
      -webkit-text-fill-color: transparent;
      animation: crazyHeaderBG 7s infinite alternate;
      ">
      Full-Stack Developer <span style="color:#00eaff; font-weight:800;">|</span>
      AI Engineer <span style="color:#00eaff; font-weight:800;">|</span>
    ...
    <div style="font-size:1.25em; font-weight:700; letter-spacing:2.5px; margin-top: 0; margin-bottom:0;">
      <span style="color: #00eaff; font-weight: 900; text-shadow: 0 0 10px #00eaff99;">
          Building Flutter Apps (Dart • Flutter)
      </span>
    </div>
        ...
        <div style="display: flex; justify-content: space-between; flex-wrap: wrap; gap: 44px; width: 92vw; max-width:1920px; margin: 0 auto;">
          ...
          <div style="flex:1; min-width:210px;">
            ...
            <div style="display:flex; justify-content:center; gap:10px;">
              ...
              <img src="https://skillicons.dev/icons?i=dart" height="46" title="Dart"/>
          ...
          <div style="flex:1; min-width:210px;">
            ...
            <div style="display:flex; justify-content:center; gap:10px;">
              ...
              <img src="https://skillicons.dev/icons?i=flutter" height="46" title="Flutter"/>
            </div>
          </div>
          <!-- FRAMEWORKS -->
          <div style="flex:1; min-width:210px;">
          ...
          <!-- TOOLS -->
          <div style="flex:1; min-width:210px;">
            <div style="font-size:1.13em; color:#00e5e5; font-weight:700; letter-spacing:1.1px; margin-bottom:16px; text-align:center;">Tools</div>
            <div style="display:flex; justify-content:center; gap:10px;">
...
<div align="center" style="margin: 120px 0;">
  <div style="margin: 30px 0;">
   <img width="48%" height="180px" src="https://github-readme-stats.vercel.app/api?username=Impact-10&show_icons=true&count_private=true&hide_border=true&title_color=00E5FF&icon_color=00E676&text_color=ffffff&bg_color=1a1a2e&border_radius=15&v=20260227" />
   <img width="48%" height="180px" src="https://github-readme-stats.vercel.app/api/top-langs/?username=Impact-10&layout=compact&hide_border=true&title_color=00E5FF&text_color=ffffff&bg_color=1a1a2e&langs_count=8&border_radius=15&v=20260227" />
  </div>
<img src="https://streak-stats.demolab.com/?user=Impact-10&theme=tokyonight&hide_border=true&border_radius=15&date_format=M%20j%5B%2C%20Y%5D&ring=00E5FF&fire=00E676&currStreakLabel=00E5FF&v=20260227" /></div>
<br />
<!-- ====== CONTACT SECTION ====== -->
<div style="display: flex; align-items: center; font-size: 1.38em; color: #00E5FF; margin-bottom: 20px;">
...
in this code, just remove kotli
